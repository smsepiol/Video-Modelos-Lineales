...
`Dune.env` contiene variables ambientales que describen características del suelo, humedad y manejo del terreno que pueden influir en la composición de las comunidades vegetales. 
...
| Variable     | Escala                | Niveles / Valores                 | Descripción                                                                                                  |
| ------------ | --------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------ |
